...
function convertToNPR($amountInUSD) {
    // Fixed conversion rate: 1 USD = 120 NPR (you can change this)
    $conversionRate = 100;
    $amountInNPR = $amountInUSD * $conversionRate;
    return number_format($amountInNPR, 2); // Format the amount to 2 decimal places
}
...
if(isset($_POST["getProduct"])){
	...
	if(mysqli_num_rows($run_query) > 0){
		while($row = mysqli_fetch_array($run_query)){
			...
			$pro_price_npr = convertToNPR($pro_price);
                        ...
                        <div class='col-md-4 col-xs-6' >
								<a href='product.php?p=$pro_id'><div class='product'>
									...
									<div class='product-body'>
										...
										<h4 class='product-price header-cart-item-info'>NPR ' . $pro_price_npr . '<del class='product-old-price'>NPR990.00</del></h4>
			...
			echo "
                        ...
                        <div class='col-md-4 col-xs-6'>
								<a href='product.php?p=$pro_id'><div class='product'>
									...
									<div class='add-to-cart'>
										<button pid='$pro_id' id='product' href='#' tabindex='0' class='add-to-cart-btn'><i class='fa fa-shopping-cart'></i> add to cart NPR</button>
									</div>
								</div>
							</div>
			";
