<script>
    function countdown() {
        ...
        const timer = setInterval(function() {
            ...
            if (distance < 0) {
                clearInterval(timer);
                document.getElementById("countdown").innerHTML = "<li>Expired</li>"; // Replace this with your expired message or action
            }
        }, 1000);
    }
    countdown();
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
	...
	<div class="item active" style="margin-top: 3px;"> <!-- Adjust the margin-top value as needed -->
    <img src="img/banner3.jpg" alt="Los Angeles" style="width: 100%;"> <!-- Adjust the width percentage as needed -->
</div>
                ...
                if(mysqli_num_rows($run_query) > 0){
                    ...
                    while($row = mysqli_fetch_array($run_query)){
                        ...
                        $cat_name = $row["cat_title"];
						   ...
						   // Convert price to Nepalese Rupees using an exchange rate (for example, 1 USD = 119 NPR)
						   $exchange_rate = 119;
						   $pro_price_npr = $pro_price * $exchange_rate; // Price in Nepalese Rupees
                        ...
                        echo "
								...
								<div class='product'>
									...
									<div class='product-body'>
										...
										<h4 class='product-price header-cart-item-info'>$pro_price<del class='product-old-price'>NPR990.00</del></h4>
							...
							<div id="get_product_home2">
								...
								<div class="product-widget">
									...
									<div class="product-body">
										...
										<h4 class="product-price">NPR980.00 <del class="product-old-price">NPR9900.00</del></h4>
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">Category</p>
										<h3 class="product-name"><a href="#">product name goes here</a></h3>
										<h4 class="product-price">NPR980.00 <del class="product-old-price">NPR990.00</del></h4>
									</div>
								</div>
								<!-- product widget -->
							</div>
