	...
	*/
	...
	function getCartItem(){
		$.ajax({
			...
			success: function(data){
				// Replace $ with NPR in the received data
				var modifiedData = data.replace(/\$/g, 'NPR');
	
				// Insert the modified data into the cart_product element
				$("#cart_product").html(modifiedData);
	
				// Recalculate net total after modifying the data
				net_total();
			}
		});
	}
